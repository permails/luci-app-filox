...
#filox-container .hexview:focus,
#filox-container .textview:focus {
	outline: none;
	box-shadow: none;
...
#filox-container .hexedit *,
#filox-container .hexedit *::before,
#filox-container .hexedit *::after {
...
#filox-container .hexedit:focus {
	outline: none;
}

/* Headers container */
#filox-container .hexedit-headers {
	display: flex;
...
/* Header styles */
#filox-container .offsets-header,
#filox-container .hexview-header,
#filox-container .textview-header {
	display: flex;
	align-items: center;
	padding: 5px;
	box-sizing: border-box;
...
#filox-container .hexview-header span {
	width: 2ch;
	margin-right: var(--span-spacing);
	text-align: center;
}

#filox-container .hexview-header span:last-child {
	margin-right: 0;
}
...
/* Content container */
#filox-container .hexedit-content {
	display: flex;
	height: 100%;
	flex: 1 1 auto;
	overflow: auto;
...
/* Columns */
#filox-container .offsets,
#filox-container .hexview,
#filox-container .textview {
	flex-shrink: 0;
	display: block;
	padding: 5px;
	position: relative;
...
/* Line containers */
#filox-container .hex-line,
#filox-container .text-line {
	display: flex;
	height: 1.2em;
}

/* Byte spans */
#filox-container .hex-line span,
#filox-container .text-line span {
	width: 2ch;
	margin-right: var(--span-spacing);
	text-align: center;
...
#filox-container .hex-line span:last-child,
#filox-container .hexview-header span:last-child,
#filox-container .text-line span:last-child {
	margin-right: 0;
}

/* Selections */
#filox-container .selected {
	background-color: var(--clr-selected);
}

#filox-container .selected-editing {
	background-color: var(--clr-selected-editing);
}

#filox-container .non-printable {
	color: var(--clr-non-printable);
}

/* Remove individual scrollbars */
#filox-container .offsets::-webkit-scrollbar,
#filox-container .hexview::-webkit-scrollbar,
#filox-container .textview::-webkit-scrollbar {
	display: none;
}
...
#filox-container .hexedit .offsets,
#filox-container .hexedit .hexview,
#filox-container .hexedit .textview {
	border-right: 2px solid var(--clr-border);
}
...
#filox-container .hexedit-search-container {
	padding: 10px;
...
/* Search group styles */
#filox-container .hexedit-search-group {
	display: flex;
	align-items: center;
	gap: 5px;
	width: 100%;
...
/* Search input fields */
#filox-container .hexedit-search-input {
	flex: 1;
	padding: 8px;
...
#filox-container .hexedit-search-status {
	width: 50px;
	text-align: center;
	font-size: 14px;
}
...
#filox-container .hexedit-search-button {
	padding: 8px 12px;
	cursor: pointer;
...
#filox-container .hexedit-search-button:hover {
	background-color: #0056b3;
}

/* Highlight search results */
#filox-container .search-highlight {
...
#filox-container .active-view-cursor {
