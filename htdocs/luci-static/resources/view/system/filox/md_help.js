return L.Class.extend({
	...
	helpContentMarkdown: `
# LuCI OpenWrt Filox Application Help

## Introduction
The **LuCI OpenWrt Filox** is a tool to navigate directories, manage files, edit content, and customize the application's settings.

## Key Features

1. **Tabbed Interface**
   - **Filox Tab**: Primary interface for browsing and managing files and directories.
...
1. **Accessing the Application**
   ...
   - Locate and select the **Filox** application from **System** menu.

2. **Navigating the Interface**
   - **Tabs**: Use the top navigation tabs to switch between **Filox**, **Editor**, **Settings**, and **Help**.
   - **Filox Tab**:
   ...
   - **Editor Tab**:
     - Select a file from the Filox to open it in the Editor.
